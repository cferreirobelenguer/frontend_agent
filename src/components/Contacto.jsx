...
import contactarnos from '../assets/images/contact.jpg'
    ...
    return(
        <div className="contacto" id="contacto" >
            ...
            <div className="imagenContacto">
                <img src={contactarnos} width="500" height="500" className="img-fluid" alt="imagen contacto"/>
            </div>
            <div className="parrafoContacto">
                <div className="tituloContacto" data-aos="fade-right">
                    <h5><b>Teléfono Servício de Atención al cliente</b></h5>
                </div>
                <h6><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
